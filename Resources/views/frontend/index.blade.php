                                ...
                                <div class="row g-0 justify-content-center">
                                    ...
                                    <div class="col-lg-4 offset-lg-1 mx-0 px-0">
                                        <div id="title-container">
                                            ...
                                            <p>Digite los siguientes datos para la generacio de Certificados</p>
                                        </div>
                                    </div>
                                    <!-- FORMS -->
                                    <div class="col-lg-7 mx-0 px-0">
                                        ...
                                        <div id="qbox-container">
                                            ...
                                            <div id="steps-container">
                                                <div class="step">
                                                    <h4>Escoja el Tipo de Certificado a Generar</h4>
                                                    <div class="mt-1">
                                                        <label class="form-label">Tipo de Certificado:</label>
                                                        <select class="form-select" onchange="insertParam(this)"
                                                                name="type_certificate" id="type_certificate"
                                                                aria-label="Default select type_certificade">
                                                ...
                                                <div class="step">
                                                    <input  id="count_vehicle"
                                                           type="hidden" value="{{count($vehicles)}}" >
                                                    @if(count($vehicles))
                                                    <h4>Selecionar Vehiculos a los cuales desea generar el/los
                                                        certificado(s)</h4>
                                                    <div class="form-check ps-0 q-box row">

                                                        @foreach($vehicles as $vehicle)
                                                            <div class="q-box__question col-6 vehicle-{{$vehicle->type_vehicle}} hidden"
                                                                 id="vehicle-{{$vehicle->type_vehicle}}">
                                                                <input class="form-check-input question__input"
                                                                       name="vehicle[]" type="checkbox"
                                                                       id="vehicle-{{$vehicle->board}}"
                                                                       value="{{$vehicle->board}}">
                                                                <label class="form-check-label question__label"
                                                                       for="vehicle-{{$vehicle->board}}">{{$vehicle->board}}</label>
                                                            </div>
                                                        @endforeach
                                                    </div>
                                                    @else
                                                        <h4>Usted no dispone de vehículos en su cuenta</h4>
                                                    @endif
                                                </div>
                                                <div class="step">
                                                    <h4>Desea el un certificado por cada Vehiculo o integrado?</h4>
                                                    <div class="form-check ps-0 q-box">
                                                        ...
                                                        <div class="q-box__question" id="box-certificate_group_1">
                                                            <input class="form-check-input question__input"
                                                ...
                                                <div class="step">
                                                    <h4>Desea Descargar o enviar el/los certificado(s)</h4>
                                                   <div class="row">
                                                       <div class="col-6">
                                                           <div class="form-check ps-0 q-box">
                                                               <div class="q-box__question">
...
@section('scripts')
    ...
    <script>
        ...
        let countVehicle = document.getElementById('count_vehicle');
        let current_step = 0;
        let stepCount = 3
    ...
    <script>
        function insertParam(x) {
            var v0 = document.getElementsByClassName("vehicle-0")
            var v1 = document.getElementsByClassName("vehicle-1")

            var cbarray = document.getElementsByName('vehicle[]');
            ...
            for(var i in v0) {
              if(typeof v0[i].classList !== 'undefined')  v0[i].classList.add('hidden')
            }
            for(var i in v1) {
                if(typeof v1[i].classList !== 'undefined'){
                    v1[i].classList.add('hidden')
                }


            }
            var whichSelected = x.selectedIndex;
            var sel = x.options[whichSelected].value;
            const elem = document.getElementsByClassName("vehicle-"+sel);
            for(var i in elem) {
                if(typeof elem[i].classList !=='undefined')   elem[i].classList.remove('hidden')
            }
            if (sel==="1"){
                document.getElementById('box-certificate_group_1').classList.add('hidden')
                document.getElementById('certificate_group_0').checked=true
            }else {
                document.getElementById('box-certificate_group_1').classList.remove('hidden')
            }
