    ...
    <div class="row">
        <div class="col-12">
            ...
            <p style="margin-top: 30px">
                Con la presente hacemos constancia de tener un acuerdo de concesión de las partes
                entre la empresa EJE SATELITAL S.A.S. identificada bajo el NIT. 901188980-9
            ...
            <p>
                El acuerdo incluye la prestación del servicio de ubicación satelital de flota a través
                de nuestro Aplicativo Web y un terminal propio del cliente, para el vehiculo
                relacionado con
                @if($document->config->type)
                 las placas: </p><p style="text-align: center"><strong class="p-1">{{$document->config->board}}</strong>
                @else
                  la  placa: </p><p style="text-align: center"> <strong>{{$document->config->vehicle->board}}</strong>
                @endif
                .
            </p>
            <p>
                Ademas damos constancia que el suscrito se encuentra activo en el momento de
                expedicion de la presente.
            </p>
            <p>
