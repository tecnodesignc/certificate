                                                                    ...
                                                                    <tr>
                                                                        <td valign="middle" align="center"
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                border="0">
                                                                                <div><img width="150" vspace="0"
                                                                                          hspace="0" border="0"
                                                                                          alt="Sendinblue"
                                                                                          style="float: left;max-width:200px;display:block;"
                                                                                          class="rnb-logo-img"
                                                                                          src="http://reportes.ejesatelital.com/themes/encore/images/logo-dark.png">
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                            ...
                                                                            <span style="color:#999;"><span
                                                                                    style="font-size:18px"><span
                                                                                        style="font-size:24px"><span
                                                                                            style="color:#FFFFFF">Certificado Eje Satelital</span></span></span></span>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td height="10"></td>
                                                        ...
                                                        <tr>
                                                            <th class="rnb-force-col"
                                                                ...
                                                                <table border="0" valign="top" cellspacing="0"
                                                                    ...
                                                                    <tbody>
                                                                    @include('certificate::frontend.emails.content')
                                                                    </tbody>
                                                                </table>
                                                                                    ...
                                                                                    <td valign="middle" align="left"
                                                                                        ...
                                                                                        <div>
                                                                                            ...
                                                                                            <div
                                                                                                style="line-height:150%;">
                                                                                                <span
                                                                                                    style="font-size: 13px; background-color: transparent;">@setting('core::address')| </span><span
